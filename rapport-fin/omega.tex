...
apprentissage non supervisé (filtre de Kalman par defaut), et ensuite on tenteras
de le contraindre à nous donner l'état neuronal lié à l'état des muscles.
...
phase d'apprentissage. L'état interne $r$ est ici un vecteur de 12 élèments.
Cette taille de vecteurs à été choisis car correspondante au nombre d'unité
neuronale du ver.

Le même jeu de donné que celui d'entrainement est ensuite fournis pour la phase
de prédiction. Sur la figure~\ref{fig:sequence_ver_complet} on peut voir que l'erreur
est grossièrement comprise entre $1\%$ et $7\%$ Avec quelques rares endroit ou l'erreur
éxcède $15\%$. Ce que nous considérons comme correct.
