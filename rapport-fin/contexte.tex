...
\subsection{Implementation de référence} % (fold)
...
Cette version du simulateur implémente tous le système sans utilisé de librairie
...
% subsection Implementation de référence (end)

\subsection{Implementation de Thomas Voegtlin} % (fold)
...
% subsection Implementation de Thomas Voegtlin (end)
