...
faible sont automatiquement considérées comme insignifiante, de même pour que
pour la taille des ressorts constituants les muscles. Nous avons donc modifié
...
était toujours nécessaire même s'il était plus faible qu'avant modification.
Ce problème sera finalement dû aux méthodes de calcul utilisées par SOFA qui ne
